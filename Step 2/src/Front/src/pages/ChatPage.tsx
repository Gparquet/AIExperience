...
const MODE_DESCRIPTIONS: Record<Mode, string> = {
  classic: 'Posez une question — les résultats les plus proches textuellement seront affichés.',
  llm: 'Posez une question — le LLM répond depuis ses connaissances générales, sans vos documents.',
  rag: 'Posez une question — le LLM synthétisera une réponse à partir de vos documents.',
};
